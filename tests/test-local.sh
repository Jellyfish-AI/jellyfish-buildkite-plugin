...
export BUILDKITE_PLUGIN_JELLYFISH_BUILDKITE_PLUGIN_API_TOKEN="test-api-token-12345"
export BUILDKITE_PLUGIN_JELLYFISH_BUILDKITE_PLUGIN_NAME="test-deployment"
export BUILDKITE_PLUGIN_JELLYFISH_BUILDKITE_PLUGIN_LABELS="environment:test service:api region:local"
...
echo "  Plugin webhook URL: $BUILDKITE_PLUGIN_JELLYFISH_BUILDKITE_PLUGIN_WEBHOOK_URL"
echo "  Plugin labels: $BUILDKITE_PLUGIN_JELLYFISH_BUILDKITE_PLUGIN_LABELS"
echo ""
